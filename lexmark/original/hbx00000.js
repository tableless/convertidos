...
var _rf=_A("Hidden-Referrer"),_et=_oe=_we=0,_ar="",_hM=(!(_II(navigator.userAgent,"Mac")>-1)),_tls="";_bv=parseInt(navigator.appVersion);
_bv=(_bv>99)?(_bv/100):_bv;var __f,_hrat=_D("hra"),_hra="",_$r=""Hidden-Referrer")+''}",_$c="catch(_e)",_hbi=new Image(),_fa=_hlfs=_hoc=0,
...
if(_II(_cmp,"SFS-")>-1){document.ignore="HBCMP="+_cmp+"; path=/;"+(_cpd!=""?(" domain=."+_cpd+"; "):"")+"expires=Wed, 1 Jan 2020 00:00:00 GMT";}
...
_ce="y";_hd=_J(document.cookie,"*");if(_TL(_hd)!="null"&&_cp=="null"){_cp=_hd}else{document.ignore="CP="+_cp+_hck}}else{document.ignore="CP="+_cp+_hck;
...
else{if(top.document&&_IL(parent.frames)>1){_rf=_A("Hidden-Referrer")+""}else if(top.document){_rf=_A(top."Hidden-Referrer")+""}}if((_rf==_hud)||
